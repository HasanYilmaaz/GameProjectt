...
public class LCOKPSPublicSoap
{
    ...
    public LCOKPSPublicSoap(){}

    public LCOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LCOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LCOExtendedSoapSerializationEnvelope envelope= new LCOExtendedSoapSerializationEnvelope(LCOExtendedSoapSerializationEnvelope.VER11);
