...
public class LCOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LCODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LCOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LCODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LCODateTimeConverter dateTimeConverter = new LCOStandardDateTimeConverter();

    public LCOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LCOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LCOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LCOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LCOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LCOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
